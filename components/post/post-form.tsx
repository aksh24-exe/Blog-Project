...
const postSchema = z.object({
  title: z
    .string()
    .min(3, "Title must be at least 2 character long")
    .max(255, "Title must be less than 255 charcter"),
  description: z
    .string()
    .min(3, "Description must be at least 2 character long")
    .max(255, "Description must be less than 255 charcter"),
  content: z.string().min(10, "Title must be at least 2 character long"),
});
